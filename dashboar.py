...
#Nah, untuk mendukung hal ini, kita perlu mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom tersebut bertipe datetime.  Berikut kode yang dapat kita gunakan untuk melakukan hal tersebut.
...
#Pada bagian awal, kita perlu menambahkan header pada dashboard tersebut. Berikut merupakan kode untuk melakukannya.
st.header('Dicoding Collection Dashboard :sparkles:')

#proyek ini, kita menampilkan informasi total order dan revenue dalam bentuk metric() yang ditampilkan menggunakan layout columns(). Di lain sisi, informasi tentang jumlah order harian ditampilkan dalam bentuk visualisasi data seperti kode berikut.
...
#Pada proyek ini, kita akan menampilkan 5 produk paling laris dan paling sedikit terjual melalui sebuah visualisasi data. Berikut contoh kode yang dapat Anda gunakan untuk melakukan hal tersebut.
